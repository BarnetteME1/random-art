def blue_duck():
n = "lambda x, y: abs(" + random.choice(math_sinh) + random.choice(pi_e) + random.choice(math_op) + random.choice(math_asinh) + random.choice(pi_e) + random.choice(math_op) + random.choice(math_sin) + random.choice(pi_e) + random.choice(math_op) + random.choice(x_y) + ")" + random.choice(math_op) + random.choice(math_sin) + random.choice(x_y) + random.choice(pi_e) + ")" + random.choice(math_op) + random.choice(math_sin) + random.choice(num_list) + random.choice(math_op) + random.choice(x_y) + "))))"
o = "lambda x, y: abs(" + random.choice(math_sin) + random.choice(num_list) + random.choice(math_op) + random.choice(math_sin) + random.choice(x_y) + random.choice(math_op) + random.choice(pi_e) + ")" + random.choice(math_op) + random.choice(math_sin) + random.choice(pi_e) + random.choice(math_op) + random.choice(math_sin) + random.choice(num_list) + random.choice(math_op) + random.choice(x_y) + "))))"
...
q = "lambda x, y:" + random.choice(math_sin) + random.choice(pi_e) + random.choice(math_op) + random.choice(math_sin) + random.choice(pi_e) + random.choice(math_op) + random.choice(math_sin) + random.choice(pi_e) + random.choice(math_op) + random.choice(math_sin) + random.choice(pi_e) + random.choice(math_op) + random.choice(math_sin) + random.choice(pi_e) + random.choice(math_op) + random.choice(x_y) + ")" + random.choice(math_op) + random.choice(x_y) + "))" + random.choice(math_op) + random.choice(math_sin) + random.choice(pi_e) + random.choice(math_op) + random.choice(x_y) + ")))"
